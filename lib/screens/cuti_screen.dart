...
class _CutiScreenState extends State<CutiScreen> {
  ...
  Future<void> _saveDataToFirestore() async {
    if (_formKey.currentState!.validate()) {
      try {
        // Menyimpan data ke koleksi 'cuti' di Firestore
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Form Cuti berhasil dikirim')),
        );
      } catch (e) {
        // Menangani error
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Form Cuti"), // Judul tetap ada
        centerTitle: true,
      ),
      body: Container(
        color: Colors.white, // Background bawah jadi putih
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // Field untuk Link File Bukti Surat Cuti
              TextFormField(
                decoration: InputDecoration(
              ...
              ElevatedButton(
                ...
                child: Text('Kirim',
                    style: TextStyle(color: Colors.white)), // Teks hitam
